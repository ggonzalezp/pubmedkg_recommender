 ...
 * UTS API Key so your program doesn't prompt for the information.
 * 
 * @author	Jim Mork
...
public class MMInteractiveUserTest
{
   public static void main(String args[])
   {
        // use uts api key defined using environment variable UTS_API_KEY
        GenericObject myIntMMObj = new GenericObject(100, System.getenv("UTS_API_KEY"));
