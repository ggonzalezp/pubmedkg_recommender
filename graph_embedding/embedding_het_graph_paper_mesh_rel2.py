...
##Adding relation-type specific matrix for the decoding 
...
def train():
	...
	# edge_type = data.train_neg_edge_type
	optimizer.zero_grad()
	z = model.encode()
	link_logits = model.decode(z, data.train_pos_edge_index, data.train_pos_edge_type, neg_edge_index, data.train_neg_edge_type)
